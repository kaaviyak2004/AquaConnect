  ...
  return loading ? (
    ...
    <>
          ...
          <div className="food_details_section">
            ...
            <div className="querySearch_user">
              ...
              <div className="veg_only">
                <button onClick={veg}>Water Cane</button>
              </div>
            </div>
          </div>
      ...
      <div className="food_products">
        <h4 className="title">{isClick ? Value : "All Water Services"}</h4>
        ...
        {cart.length ? (
          ...
          <div className="cart_empty">
            ...
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkiwnDeJ4qDhw0W5p7g0Awsognb42tQ-Aphw&s"
              alt=""
              className="empty_cart_img"
            />
            <p className="empty_cart_para">
                Go ahead, order some from the menu.
            </p>
          </div>
        )}
      </div>
